...
const dataMedicare = require('../lib/data-medicare');

const configSrc = path.join(process.cwd(), '/data/config.json');
var config = require(configSrc);

const dataPath = path.join(process.cwd(), '/data');

module.exports = function(req, res, next) {
	// http://delog.wordpress.com/2012/05/13/a-simple-read-only-configuration-module-for-node-js/
